...
import { MoviesBannerProps } from './MoviesBannerProps'

export const MoviesBanner = (props: MoviesBannerProps) => {
	const { movieItems } = props

	return (
		<section className="movies-banner container" aria-labelledby="movies-banner-title">
