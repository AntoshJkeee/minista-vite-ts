...
export const Support = () => {
	return (
		<section className="support container" aria-labelledby="support-title">
			...
			<form action="" className="support__form">
				<Field className="support__form-cell" label="First Name" placeholder="John" isRequired />
				<Field className="support__form-cell" label="Last Name" placeholder="Doe" isRequired />
				<Field className="support__form-cell" label="Email" type="email" placeholder="example@example.com" isRequired />
				<Field
					...
					renderBefore={(buttonClassName) => (
						<Select
							...
							options={[{ value: '+7', isSelected: true }, { value: '+1' }, { value: '+2' }, { value: '+3' }]}
						/>
					)}
				/>
				<Field
				...
				<div className="support__form-cell support__form-cell--wide support__form-cell--actions">
					<Checkbox
						...
						isRequired
					/>
					<Button className="support__form-submit-button" label="Send Message" type="submit" />
				</div>
			</form>
		</section>
	)
