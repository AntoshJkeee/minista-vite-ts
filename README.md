...
- [x] возможно добавить TS для удобного автокомплита // не зашло т.к spread операторы не ругаются на лишние свойства
- [ ] разобраться с Advanced каталогом в доке minista (я)
- [ ] положить в utils constants и helpers из вспомогательных функций
